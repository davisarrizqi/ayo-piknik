...
<body class="m-0 p-0 bg-black/10">
    <form class="w-screen h-screen flex relative" onchange="checkIsFilled()" action="/register" method="post">
        @csrf
        {{-- <div class="absolute w-[25%] h-full flex">
            <div class="w-20 h-20 m-auto bg-red-500">

            </div>
        </div>

        <div class="absolute w-[25%] left-[75%] mx-auto h-full flex">
            <div class="w-20 h-20 m-auto bg-green-500">
            ...
            <div class="right-element flex w-full h-full">
                <div class="w-[75%] mr-auto my-auto text-blue-500/80">
                    ...
                    <div class="password-confirmation-contextor w-full mt-5">
                        ...
                        <div class="w-full flex justify-around gap-5">
                            <input onchange="generateMessage()" oninput="validateConfirmationInput()" class="mt-1 transition-all ease-in-out duration-300 focus:px-5 py-2 w-full border-b-2 outline-black/40" type="password" name="password-confirmation" id="password-confirmation" placeholder="Konfirmasi Password Kamu">
                            <div class="flex w-10">
